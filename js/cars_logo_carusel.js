(function() {
    ...
    document.getElementById('manufacture_carusel_btn_ford').addEventListener('click', nextSlide);
    document.getElementById('manufacture_carusel_btn_audi').addEventListener('click', prevSlide);
